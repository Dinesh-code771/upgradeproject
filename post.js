...
function getcommentdata(){
    ...
    { 
        if(comment[i]==undefined){
            ...
            document.querySelectorAll(".smallcontainer")[i].innerText=info;
            document.querySelectorAll(".smallcontainer")[i].style.border="10px solid lightgray"
        }
...
function writingcomment(id){  
    ...
    comment[id]=document.querySelectorAll(".comment")[id].value+"\n"+ar[id];
    localStorage.setItem("comment",JSON.stringify(comment))
    document.querySelectorAll(".smallcontainer")[id].style.border="10px solid lightgray"
...
function displaycomment(id)
{
   ...
   info=(data[id]+"\n").replace("undefined"," ");
    ...
    document.querySelectorAll(".smallcontainer")[id].innerText=info;
}
